...
// Storage initialization - Supabase only (as per project requirements)
export async function initializeStorage(): Promise<IStorage> {
  try {
    // Supabase is mandatory - no fallback options
