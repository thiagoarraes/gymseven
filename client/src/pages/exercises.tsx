        ...
        <CardContent className="mobile-card-padding space-y-6">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-24 pr-4 h-12 min-h-[44px] py-3 text-base font-medium bg-white/80 dark:bg-slate-800/50 border-blue-200/50 dark:border-slate-700 text-foreground placeholder-muted-foreground focus:border-blue-400/60 dark:focus:border-blue-500/50 mobile-focus"
