        ...
        <CardContent className="p-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <div className="text-sm font-medium text-white truncate">
                {currentExercise?.exercise?.name || currentExercise?.name || 'Carregando exercício...'}
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="text-sm font-medium text-emerald-400">
                {currentExercise ? `Série ${currentSetIndex + 1} de ${currentExercise.sets}` : 'Preparando...'}
              </div>
          ...
          <div className="mt-4 pt-4 border-t border-slate-700/30">
            <div className="grid grid-cols-3 gap-4 text-center">
              <div>
                <div className="text-lg font-semibold text-blue-400">{templateExercises.length || 0}</div>
