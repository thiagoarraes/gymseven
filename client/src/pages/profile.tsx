                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-foreground">Altura (cm)</FormLabel>
                              <FormControl>
                                <Input
                                  {...field}
                                  type="number"
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-foreground">Peso (kg)</FormLabel>
                              <FormControl>
                                <Input
                                  {...field}
                                  type="number"
                          ...
                          <FormItem>
                            ...
                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                              ...
                              <SelectContent className="bg-card border-border">
                                <SelectItem value="sedentario" className="text-foreground">Sedentário (pouco ou nenhum exercício)</SelectItem>
                                <SelectItem value="leve" className="text-foreground">Leve (exercício leve 1-3 dias/semana)</SelectItem>
                                <SelectItem value="moderado" className="text-foreground">Moderado (exercício moderado 3-5 dias/semana)</SelectItem>
                                <SelectItem value="ativo" className="text-foreground">Ativo (exercício pesado 6-7 dias/semana)</SelectItem>
                                <SelectItem value="muito_ativo" className="text-foreground">Muito Ativo (exercício muito pesado ou trabalho físico)</SelectItem>
                              </SelectContent>
                            </Select>
                            <FormMessage />
                          </FormItem>
