    ...
    <WorkoutProvider>
      <div className="min-h-screen bg-background" style={{ position: 'relative' }}>
        ...
        <div className="overflow-y-auto scroll-behind-fixed" style={{ height: '100vh', paddingTop: '0px', paddingBottom: '0px' }}>
          <main className="mobile-container mobile-spacing" style={{ paddingTop: '66px', paddingBottom: 'calc(82px + env(safe-area-inset-bottom))', paddingLeft: '1rem', paddingRight: '1rem' }}>
            <Switch>
