...
export function Logo({ imagePath, alt = "GymSeven Logo", className }: LogoProps) {
  return (
    <div className="flex items-center">
      {imagePath ? (
        <img
          src={imagePath}
          alt={alt}
          className={`h-12 w-auto max-w-[200px] object-contain drop-shadow-lg ${className || ""}`}
          loading="lazy"
        />
      ) : (
        // Fallback - logo SVG original caso não tenha imagem
