...
export function BottomNavigation() {
  ...
  return (
    <nav className="fixed-footer fixed bottom-0 left-0 right-0 z-50 glassmorphism border-t border-border/20 shadow-2xl mobile-safe-bottom backdrop-blur-xl" style={{ position: 'fixed', bottom: '0', left: '0', right: '0', zIndex: 10000 }}>
