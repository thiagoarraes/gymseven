...
-- Criação das tabelas do GymSeven no Supabase
...
-- 9. Tabela de registros de treino
...
async function createTables() {
  try {
    ...
    if (tablesError) {
      console.log('ℹ️ Não foi possível verificar as tabelas automaticamente');
    } else {
